        ...
        <div>
          ...
          <div className="flex items-center justify-between pb-6 border-b-3 border-black">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-amber-400 flex items-center justify-center border-2 border-black">
                <Zap className="w-5 h-5 text-slate-900 fill-amber-300" />
              </div>
