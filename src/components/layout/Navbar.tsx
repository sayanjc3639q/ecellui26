      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-amber-400 rounded-xl flex items-center justify-center border-2 border-black shadow-[2px_2px_0px_0px_#000]">
              <Zap className="w-6 h-6 text-slate-900 fill-amber-300" />
            </div>
            <div className="flex flex-col">
              <span className="font-display font-black text-xl tracking-tighter leading-none text-slate-900">
                E-Cell
              </span>
              <span className="font-display font-bold text-[10px] text-slate-500 tracking-widest uppercase">
                HIT HALDIA
              </span>
            </div>
          </Link>
